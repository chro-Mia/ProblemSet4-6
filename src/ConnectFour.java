...
public class ConnectFour
{
    ...
    private void gameOptions()
    {
        ...
        System.out.println("How many in a row are required to win?");
        numToWin = reader.nextInt();
        reader.nextLine(); // Clear the buffer
        ...
        p1.setMark(new String("X"));
        p2.setMark(new String("O"));
    ...
    private void oneGame()
    {
        ...
        board = new Board(numRows, numCols, numToWin);        // Initially board shows locations of squares 1 - 9
    ...
    private boolean oneTurn(Player p)
    {
        ...
        int move = p.pickSquare(board.copy());
